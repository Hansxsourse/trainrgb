...
parser.add_argument("--train_df", default="/home/xsourse_cc/train.csv", type=str)
parser.add_argument("--sub_df", default="/home/xsourse_cc/sample_submission.csv", type=str)
parser.add_argument("--train_dir", default='/home/xsourse_cc/train/', type=str)
parser.add_argument("--test_dir", default='/home/xsourse_cc/test/', type=str)
parser.add_argument("--p2h", default='./p2h.pickle', type=str)
parser.add_argument("--p2size", default='./p2size.pickle',
                    type=str)
parser.add_argument("--bb_df", default="./bounding_boxes.csv", type=str)
...
if not args.predict_only:
    ...
    make_steps(3, 1000,use_lap=False)
